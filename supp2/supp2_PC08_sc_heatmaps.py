...
# filter out artifact and germline HOM
...
GOI=["RNF111", "REV3L", "H3C8", "TP53", "KMT2D", "TP53", "KRAS"]
...
fig.write_image(
	...
	width = 200 + 10 * len(snv_df.index.tolist())
)
...
sc_cnv_heatmap = pt.cnv.heatmap(
    ...
    features = ["TGFBR2",  "CDKN2A", "BMPR1A", "KRAS", "ACVR1B", "SMAD4"],
