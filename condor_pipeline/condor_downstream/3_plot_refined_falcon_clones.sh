...
# SAMPLE_NAMES=$(ls /data/iacobuzc/haochen/Tapestri_batch2/analysis/condor-pipeline/condor_downstream)
...
OUTPUT_DIR=/data/iacobuzc/haochen/Tapestri_batch2/analysis/condor-pipeline/condor_downstream
for patient_i in ${SAMPLE_NAMES[@]}; do
    ...
    python ${PLOT_SCRIPT} \
        ...
        --cn_clone_profiles_csv ${OUTPUT_DIR}/ete_trees_refined_subclonal_snvs/${patient_i}/${patient_i}_final_clone_cn_profiles.csv \
        --sample_sc_clone_assignment_csv ${OUTPUT_DIR}/ete_trees_refined_subclonal_snvs/${patient_i}/${patient_i}_final_sc_clone_assignment.csv \
        --output_dir ${OUTPUT_DIR}/ete_trees_refined_subclonal_snvs/${patient_i}/refined_cn_info \
        --omit_clone_cleanup
        # --plot_homdel True \
